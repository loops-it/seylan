                                    ...
                                    <div className="d-flex flex-column justify-content-center align-items-center home-txt-container w-100 pt-3 pt-lg-5">
                                        <div className="conlainer-fluid m-0 px-3 px-lg-0 py-3 pt-lg-5 py-lg-5 w-100 d-flex justify-content-center align-items-center position-relative">
                                             <div className="d-flex flex-column justify-content-center align-items-center text-center mt-5  ">
                                                <div className='transparent-select-box-future'>
                                                    <Image className='ai_generated-image' src={'/seylan/final_page/ai_image.png'} alt='' height={10000} width={10000}></Image>
                                                    <Image className='seylan-logo-on-image' src={'/seylan/seylan_logo.png'} alt=';' width={100} height={100}></Image>
                                                    <div className='watermark-text'>
                                                        <h6 className='watermark-first'>Dream it. See it. </h6>
                                                        <h4 className='watermark-second'>ACHIEVE IT</h4>
                                                    </div>
                                                </div>
                                                <div>
